...
**P1 — Skills model + recommended tech (advisory).**
`technician_skills`, `technician_certifications`, repair_type `required_cert`; skills admin UI; `route-technician` endpoint; pre-fill (overridable) on HC/jobsheet assignment. Skill-segmented capacity RPC.
