 ...
 * customer-link expiry, auto-expiry of stale estimates, require-signature on accept,
 * and the terms & conditions text shown on the estimate portal.
 *
 * Settings live as columns on organization_settings (20260626160000_estimates_send.sql).
 * Mounted under /api/v1/organizations/:orgId/estimate-settings.
 */
