  ...
  try {
    ...
    const cards = healthChecks.map(hc => {
      ...
      return {
        ...
        // Many-to-one embed → a single object at runtime, though the client types it as an array.
        jobsheetReference: ((hc.jobsheet as unknown) as { reference: string | null } | null)?.reference ?? null,
