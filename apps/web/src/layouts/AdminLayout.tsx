      ...
      >
        ...
        <div className="relative flex-1 overflow-hidden">
          <nav ref={navRef} className={`h-full overflow-y-auto ${isCollapsed ? 'p-2' : 'p-4'} space-y-1`}>
            ...
            <NavTooltip label="Usage">
              <Link to="/admin/usage" className={navLinkClass('/admin/usage')}>
                <svg className={`w-5 h-5 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NavTooltip label="Communications">
              <Link to="/admin/communications" className={navLinkClass('/admin/communications')}>
                <svg className={`w-5 h-5 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <NavTooltip label="Alerts">
              <Link to="/admin/alerts" className={navLinkClass('/admin/alerts')}>
                <svg className={`w-5 h-5 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="pt-4 mt-4 border-t border-gray-800">
              ...
              <NavTooltip label="Super Admins">
                <Link to="/admin/super-admins" className={navLinkClass('/admin/super-admins')}>
                  <svg className={`w-5 h-5 ${isCollapsed ? '' : 'mr-3'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  {!isCollapsed && 'Super Admins'}
                </Link>
              </NavTooltip>
