/**
 * Collects silent diagnostics attached to every feedback report: current route,
 * app version/build, browser + device, viewport, recent console errors, and
 * timezone. Token-like query params are stripped from the URL; no auth tokens,
 * storage, or cookies are ever collected.
 */
