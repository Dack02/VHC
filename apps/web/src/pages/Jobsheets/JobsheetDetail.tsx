      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between mt-2 gap-4">
          ...
          <div className="flex items-center gap-2">
            {js.healthCheck && (
              <Link to={`/health-checks/${js.healthCheck.id}`} className="px-3 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50">
                Open VHC{js.healthCheck.vhcReference ? ` · ${js.healthCheck.vhcReference}` : ''}
              </Link>
            )}
            {!editing ? (
