...
const CARD_MODULE: Record<string, ModuleKey> = {
  ...
  '/settings/part-categories': 'parts_stock',
  '/settings/stock-locations': 'parts_stock'
}
...
export default function SettingsHub() {
  ...
  const generalCards: SettingsCard[] = [
    ...
    },
    {
      ...
      title: 'Workflow',
      description: 'Check-in & MRI settings (apply to health checks and jobsheets)',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      to: '/settings/workshop-board',
      title: 'Workshop Planner',
      description: 'Working day, board columns, queues, and technician capacity',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      to: '/settings/workshop-statuses',
      title: 'Job Statuses',
      description: 'Job status flags, colours, and SMS triggers',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'Main Booking Requirement',
      description: 'The main reason a vehicle is booked in (MOT, Service, Repair…)',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      to: '/settings/booking-codes',
      title: 'Booking Codes',
      description: 'Multi-select booking tags for jobsheets (Waiting, Courtesy Car…)',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
        </svg>
    ...
    {
      to: '/settings/repair-types',
      title: 'Repair Types',
      description: 'Classify work groups (Clutch, Service, MOT…); sets the labour rate and powers reporting',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      to: '/settings/stock-locations',
      title: 'Stock Locations',
      description: 'Where stock physically lives (stores, vans)',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
    ...
    },
    {
      ...
      title: 'MRI Items',
      description: 'MRI items checked at check-in (health checks & jobsheets)',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Enable/disable, simulation mode, send window, and test sends',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      to: '/settings/unable-to-send-reasons',
      title: 'Unable to Send Reasons',
      description: 'Manage reasons why health checks cannot be sent to customers',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const systemCards: SettingsCard[] = [
    ...
    {
      to: '/settings/daily-sms-overview',
      title: 'Daily SMS Overview',
      description: 'Configure end-of-day SMS summary for managers',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Edit SMS & email wording for health checks, reminders & follow-ups',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
        </svg>
